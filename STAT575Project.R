...
# Create a "pretty" scree plot and possibly a bibplot
...
# Model and variable selection. Ask Jan.
# Look at multicollinearity and other model diagnostics

########################
### Cluster Analysis ###
########################

fit <- kmeans(pca1, 5) # 5 cluster solution
# get cluster means 
aggregate(pca1,by=list(fit$cluster),FUN=mean)
# append cluster assignment
mydata <- data.frame(mydata, fit$cluster)

# Cluster teams and put them in tiers
